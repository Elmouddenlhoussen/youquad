...
const Footer: React.FC = () => {
  ...
  const footerClass = theme === 'dark' 
    ? 'bg-sand-900 text-sand-100 border-t border-sand-700' 
  ...
  const linkClass = theme === 'dark'
    ? 'text-sand-300 hover:text-terracotta-300'
    : 'text-sand-100 hover:text-terracotta-300';
          ...
          <div className="animate-fade-in">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <span className={theme === 'dark' ? 'text-sand-300' : 'text-sand-100'}>+212 600 000 000</span>
              </li>
              <li className="flex items-center">
                <Mail className={`h-5 w-5 ${theme === 'dark' ? 'text-terracotta-400' : 'text-terracotta-400'} mr-2`} />
                <span className={theme === 'dark' ? 'text-sand-300' : 'text-sand-100'}>info@youquad.com</span>
              </li>
            </ul>
          </div>
        </div>

        <div className={`border-t ${theme === 'dark' ? 'border-sand-700' : 'border-sand-700'} mt-12 pt-6 text-center`}>
